...
const Sidebar = () => {
  ...
  return (
    <>
      <nav
        className="fixed top-2 left-2 w-[90vh] border-2 rounded-lg  h-[98vh] border-r bg-white space-y-8 sm:w-80">
        <div class="flex flex-col h-full px-4">
          <div className='h-20 flex items-center pl-2'>
            <div className="w-full flex items-center gap-x-4">
              <img src="https://randomuser.me/api/portraits/women/79.jpg" className="w-10 h-10 rounded-full" />
              <div>
                <span className="block text-gray-700 text-sm font-semibold">Nihat A</span>
                <span
